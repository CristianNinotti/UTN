...
int main()
{
    ...
    if(dni > 1000000 && dni < 99999999)
    {
        ...
        if((medioPago == 0) || (medioPago == 2 && (tarjeta == 0 || cantCuotas == 0)))
         //tenemos que validar si el medio de pago es 1 o 2, la tarjeta es un numero entre 1 y 4 y cantidad de cuotas un 1, 3 6 o 12
         //si hay algun dato invalido muestro mensaje
        {
